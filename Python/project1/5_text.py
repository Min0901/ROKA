...
# 화면 타이틀 설정
pygame.display.set_caption("Chung Game") # 게임 이름
...
# 캐릭터(스프라이트) 불러오기
character = pygame.Surface((70,70))
...
while running:
    dt = clock.tick(60) # 게임화면의 초당 프레임 수를 설정(dt는 프레임에 반비례)
    ...
    # 타이머 집어 넣기
    # 경과 시간 계산
    elapsed_time = (pygame.time.get_ticks() - start_ticks) / 1000 # 초 단위로 환산
